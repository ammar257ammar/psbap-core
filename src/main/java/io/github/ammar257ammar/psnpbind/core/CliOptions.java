...
public class CliOptions {
	...
	@Option(names = {"-op", "--operation"}, description = "select an operation to perform: init, pocket-snps-mapping-and-foldx-prep, foldx-report, prepare-ligands-folders, ligands-tanimoto-dataset, prepare-vina-folders-config, generate-features", required = true)
	String operation = "";
